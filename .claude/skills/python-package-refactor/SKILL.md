...
```bash
uv run python .claude/skills/python-package-refactor/scripts/inspect_python_package.py --root . --format markdown
uv run python .claude/skills/python-package-refactor/scripts/api_surface_snapshot.py snapshot --root . --output /tmp/api-before.json
uv run python .claude/skills/python-package-refactor/scripts/refactor_quality_gate.py plan --root .
```

After a refactor batch:

```bash
uv run python .claude/skills/python-package-refactor/scripts/api_surface_snapshot.py snapshot --root . --output /tmp/api-after.json
uv run python .claude/skills/python-package-refactor/scripts/api_surface_snapshot.py compare /tmp/api-before.json /tmp/api-after.json
uv run python .claude/skills/python-package-refactor/scripts/refactor_quality_gate.py run --root . --output /tmp/refactor-gates.json
```

If this skill is installed somewhere other than `.claude/skills/python-package-refactor`, adjust the script paths to the actual skill directory.
