---
name: implement-core
description: "Use this agent when implementing or modifying pure domain logic under src/runops/core/, including manifest/state/run identity contracts and core boundary tests."
---
