...
created_at: '2026-05-17T04:09:06+09:00'
status: active
...
# E0012: FB0012-hops-update-harness-gitignore-whitespace を評価

## フィクスチャ

- source_feedback: `harness-lab/records/feedback/FB0012-hops-update-harness-gitignore-whitespace.md`
- fixture_dir: `harness-lab/records/eval-cases/fixtures/E0012`
- observation: GitHub issue: https://github.com/Nkzono99/runops/issues/86
author: Nkzono99
...
- `hops lab eval --case E0012 --manual` の score と notes で採用判断に必要な証拠を説明できる。
