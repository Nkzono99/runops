...
created_at: '2026-05-17T04:08:54+09:00'
status: active
...
# E0011: FB0011-hops-github-flow-pr-view-checks-watch を評価

## フィクスチャ

- source_feedback: `harness-lab/records/feedback/FB0011-hops-github-flow-pr-view-checks-watch.md`
- fixture_dir: `harness-lab/records/eval-cases/fixtures/E0011`
- observation: GitHub issue: https://github.com/Nkzono99/runops/issues/85
author: Nkzono99
...
- `hops lab eval --case E0011 --manual` の score と notes で採用判断に必要な証拠を説明できる。
